...
if(pai.ordemAtaques[0] == ataqueAmarelo) txt = "1º" // Armazena o valor na ordem que foi selecionado
if(pai.ordemAtaques[1] == ataqueAmarelo) txt = "2º" // Armazena o valor na ordem que foi selecionado
if(pai.ordemAtaques[2] == ataqueAmarelo) txt = "3º" // Armazena o valor na ordem que foi selecionado
...
draw_set_color(c_white)
draw_text(x + 65,y+20, "Meteoro de Threads") // Define o nome e a posição do ataque
